...
if("TRUE" STREQUAL "TRUE")
  set(dbw_mkz_msgs_SOURCE_PREFIX /capstone/ros/src/dbw_mkz_msgs)
  set(dbw_mkz_msgs_DEVEL_PREFIX /capstone/ros/devel)
  ...
  set(dbw_mkz_msgs_INSTALL_PREFIX /capstone/ros/install)
...
if(NOT "/capstone/ros/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dbw_mkz_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/capstone/ros/src/dbw_mkz_msgs/${idir}'.  ${_report}")
    endif()
